...
/**
 * Implementação do DAO do objeto Transacao para o SGBD PostgreSql
 * @author Edison Klafke Fillus
 * @author Jefferson de Souza Campos
 */
public class PostgreSqlTransacaoDAO extends PostgreSqlDAOFactory implements TransacaoDAO {
