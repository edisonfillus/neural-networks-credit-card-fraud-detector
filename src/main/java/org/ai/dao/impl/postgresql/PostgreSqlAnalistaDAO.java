...
/**
 * Implementação do DAO do objeto Analista para o SGBD PostgreSql
 * @author Edison Klafke Fillus
 * @author Jefferson de Souza Campos
 */
public class PostgreSqlAnalistaDAO extends PostgreSqlDAOFactory implements AnalistaDAO {
