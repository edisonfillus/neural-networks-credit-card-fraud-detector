...
/**
 * Implementação do DAO do objeto Banco para o SGBD PostgreSql
 * @author Edison Klafke Fillus
 * @author Jefferson de Souza Campos
 */
public class PostgreSqlBancoDAO extends PostgreSqlDAOFactory implements BancoDAO {
