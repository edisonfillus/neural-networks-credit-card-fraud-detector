...
/**
 * Implementação do DAO do objeto Estado para o SGBD PostgreSql
 * @author Edison Klafke Fillus
 * @author Jefferson de Souza Campos
 */
public class PostgreSqlEstadoDAO extends PostgreSqlDAOFactory implements EstadoDAO {
