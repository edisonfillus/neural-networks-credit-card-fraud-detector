...
/**
 * Implementação do DAO do objeto Estabelecimento para o SGBD PostgreSql
 * @author Edison Klafke Fillus
 * @author Jefferson de Souza Campos
 */
public class PostgreSqlEstabelecimentoDAO extends PostgreSqlDAOFactory implements EstabelecimentoDAO {
    ...
    public PostgreSqlEstabelecimentoDAO() {
    }
