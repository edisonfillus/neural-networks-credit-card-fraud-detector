...
/**
 * Implementação do DAO do objeto Alerta para o SGBD Hsqldb
 * @author Edison Klafke Fillus
 * @author Jefferson de Souza Campos
 */
public class HsqldbAlertaDAO extends HsqldbDAOFactory implements AlertaDAO {
