...
/**
 * Implementação do DAO do objeto Cidade para o SGBD Hsqldb
 * @author Edison Klafke Fillus
 * @author Jefferson de Souza Campos
 */
public class HsqldbCidadeDAO extends HsqldbDAOFactory implements CidadeDAO {
