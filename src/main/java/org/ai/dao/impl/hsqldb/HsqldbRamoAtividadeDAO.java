...
/**
 * Implementação do DAO do objeto RamoAtividade para o SGBD Hsqldb
 * @author Edison Klafke Fillus
 * @author Jefferson de Souza Campos
 */
public class HsqldbRamoAtividadeDAO extends HsqldbDAOFactory implements RamoAtividadeDAO {
