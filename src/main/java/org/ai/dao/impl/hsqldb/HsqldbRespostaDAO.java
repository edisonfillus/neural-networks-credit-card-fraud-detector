...
/**
 * Implementação do DAO do objeto Resposta para o SGBD Hsqldb
 * @author Edison Klafke Fillus
 * @author Jefferson de Souza Campos
 */
public class HsqldbRespostaDAO extends HsqldbDAOFactory implements RespostaDAO {
